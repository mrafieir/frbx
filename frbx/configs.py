...
class galaxy_configs:
    ...
    def surveys(name):
        ...
        cat = {'sdss_dr8': {'survey_name': 'sdss_dr8',
                            ...
                            'zmax': 1.1,
                            'zerr': 0.01,
                            'dndz_data': fx.data_path('dndz_sdss_dr8.txt', envar='FRBXDATA'),
                            'zbin_fmt': 'edge',
                            'nspl': 10,
                            'ntrap': 10,
                            'solver': None},
               ...
               '2mpz': {'survey_name': '2mpz',
                        ...
                        'zerr': 0.015,
                        'dndz_data': fx.data_path('dndz_2mpz.txt', envar='FRBXDATA'),
                        'zbin_fmt': 'edge',
                        'nspl': 11,
                        'ntrap': 10,
                        'solver': None},
               ...
               'desi_baseline': {'survey_name': 'desi_baseline',
                                 ...
                                 'zmax': 1.7,
                                 'zerr': 0.01,
                                 'dndz_data': fx.data_path('dndz_desi.txt', envar='FRBXDATA'),
                                 'zbin_fmt': 'edge',
                                 'nspl': 7,
                                 'ntrap': 10,
                                 'solver': 'Nelder-Mead'},
               ...
               'wise_scos_svm': {'survey_name': 'wise_scos_svm',
                                 ...
                                 'zmax': 0.5,
                                 'zerr': 0.033,
                                 'dndz_data': fx.data_path('dndz_wise_scos_svm.txt', envar='FRBXDATA'),
                                 'zbin_fmt': 'edge',
                                 'nspl': 18,
                                 'ntrap': 10,
                                 'solver': None},
               ...
               'desi_bgs': {'survey_name': 'desi_bgs',
                            ...
                            'zmax': 0.6,
                            'zerr': 0.08,
                            'dndz_data': fx.data_path('dndz_desi_bgs.txt', envar='FRBXDATA'),
                            'zbin_fmt': 'edge',
                            'nspl': 7,
                            'ntrap': 10,
                            'solver': None},
               ...
               'desi_lrg': {'survey_name': 'desi_lrg',
                            ...
                            'zmax': 1.2,
                            'zerr': 0.08,
                            'dndz_data': fx.data_path('dndz_desi_lrg.txt', envar='FRBXDATA'),
                            'zbin_fmt': 'edge',
                            'nspl': 10,
                            'ntrap': 10,
                            'solver': 'Nelder-Mead'},
               ...
               'desi_elg': {'survey_name': 'desi_elg',
                            ...
                            'zmax': 1.4,
                            'zerr': 0.2,
                            'dndz_data': fx.data_path('dndz_desi_elg.txt', envar='FRBXDATA'),
                            'zbin_fmt': 'edge',
                            'nspl': 10,
                            'ntrap': 10,
                            'solver': 'Nelder-Mead'}}
